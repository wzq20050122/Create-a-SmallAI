...
def init_model(args):
    ...
    if args.load == 0:
        ...
        model = SmallAIForCausalLM(SmallAIConfig(
...
def main():
    parser = argparse.ArgumentParser(description="Chat with SmallAI")
    parser.add_argument('--lora_name', default='None', type=str)
    parser.add_argument('--out_dir', default='out', type=str)
    parser.add_argument('--checkpoint_path', default=None, type=str, help='直接指定检查点文件路径')
